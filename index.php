...
<body>
    ...
    <section class="sections">
        <ul>
            <li class="list-item">Introduzione</li>
             <li class="list-item">Norme sulla privacy</li>
              <li class="list-item">Termini di servizio</li>
               <li class="list-item">Tecnologie</li>
                <li class="list-item">Domande frequenti</li>    
        </ul>
    </section>
